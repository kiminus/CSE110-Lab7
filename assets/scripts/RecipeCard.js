...
class RecipeCard extends HTMLElement {
  ...
  constructor() {
    ...
    shadow.appendChild(articleComp);
  }
  ...
  set data(data) {
    ...
    const articleComp = this.shadowRoot.querySelector('article');
    ...
    titleText.href = data.titleLnk;
    titleText.innerText = data.titleTxt;
    ...
    ratingDiv.append(rating_span, rating_img, rating_span2);

    const time = document.createElement('time');
    time.innerText = data.lengthTime;

    const ingre = document.createElement('p');
    ingre.innerText = data.ingredients;
    ingre.classList.add('ingredients');

    articleComp.append(image, title, organization, ratingDiv, time, ingre);
  }
}
